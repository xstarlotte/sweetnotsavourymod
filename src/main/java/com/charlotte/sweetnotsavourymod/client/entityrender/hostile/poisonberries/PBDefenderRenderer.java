...
public class PBDefenderRenderer extends GeoEntityRenderer<PBDefenderEntity> {
    ...
    public PBDefenderRenderer(EntityRendererManager renderManager) {
    ...
    @Override
    public RenderType getRenderType(PBDefenderEntity animatable, float partialTicks, MatrixStack stack,
