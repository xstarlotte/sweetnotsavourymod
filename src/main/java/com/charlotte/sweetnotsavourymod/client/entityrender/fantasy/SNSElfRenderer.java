...
public class SNSElfRenderer extends GeoEntityRenderer<SNSElfEntity> {
	...
	public SNSElfRenderer(EntityRendererManager renderManager) {
	...
	@Override
	public void renderEarly(SNSElfEntity animatable, MatrixStack stackIn, float ticks, IRenderTypeBuffer renderTypeBuffer,
