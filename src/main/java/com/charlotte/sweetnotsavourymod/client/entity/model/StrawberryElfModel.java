...
public class StrawberryElfModel<T extends StrawberryElfEntity> extends EntityModel<T> {
	...
	public StrawberryElfModel() {
		...
		hair.addChild(stalk);
		stalk.setTextureOffset(4, 19).addBox(-0.5F, -3.7F, -0.9F, 1.0F, 2.0F, 1.0F, 0.0F, false);
		...
		stalk2.setTextureOffset(15, 12).addBox(-1.5F, -2.7F, -0.9F, 2.0F, 1.0F, 1.0F, 0.0F, false);
		...
		ears2.setTextureOffset(12, 8).addBox(-3.1F, 0.2F, 1.5F, 1.0F, 1.0F, 0.0F, 0.0F, false);

		ears = new ModelRenderer(this);
		ears.setRotationPoint(0.0F, -0.7F, -1.5F);
		allears.addChild(ears);
		ears.setTextureOffset(12, 8).addBox(-3.1F, 0.2F, 1.5F, 1.0F, 1.0F, 0.0F, 0.0F, false);
