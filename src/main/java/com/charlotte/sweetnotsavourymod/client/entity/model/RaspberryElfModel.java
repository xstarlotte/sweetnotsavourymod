...
public class RaspberryElfModel<T extends RaspberryElfEntity> extends EntityModel<T> {
	...
	public RaspberryElfModel() {
		...
		hair.addChild(stalk);
		stalk.setTextureOffset(8, 26).addBox(-2.5F, -6.7F, 0.1F, 5.0F, 5.0F, 0.0F, 0.0F, false);
		...
		stalk_r1.setTextureOffset(8, 26).addBox(-2.5F, -16.7F, 0.1F, 5.0F, 5.0F, 0.0F, 0.0F, false);
		...
		stalk_r2.setTextureOffset(8, 26).addBox(-2.5F, -16.7F, 0.1F, 5.0F, 5.0F, 0.0F, 0.0F, false);
		...
		stalk_r3.setTextureOffset(8, 26).addBox(-2.5F, -16.7F, 0.1F, 5.0F, 5.0F, 0.0F, 0.0F, false);
		...
		ears2.setTextureOffset(19, 27).addBox(-10.5F, 0.2F, 1.5F, 4.0F, 1.0F, 0.0F, 0.0F, false);
