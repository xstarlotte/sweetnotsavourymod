...
public class VanillaElfModel<T extends VanillaElfEntity> extends EntityModel<T> {
	...
	private final ModelRenderer stalk_r4;
	private final ModelRenderer stalk_r5;
	private final ModelRenderer stalk_r6;
	...
	public VanillaElfModel() {
		...
		hair.addChild(stalk);
		stalk.setTextureOffset(8, 26).addBox(-2.5F, -7.2F, 0.1F, 5.0F, 5.0F, 0.0F, 0.0F, false);

		stalk_r1 = new ModelRenderer(this);
		stalk_r1.setRotationPoint(0.0F, 10.0F, 0.0F);
		stalk.addChild(stalk_r1);
		setRotationAngle(stalk_r1, -3.1416F, 0.7854F, 3.1416F);
		stalk_r1.setTextureOffset(8, 26).addBox(-2.6F, -17.2F, 0.0F, 5.0F, 5.0F, 0.0F, 0.0F, false);

		stalk_r2 = new ModelRenderer(this);
		stalk_r2.setRotationPoint(0.0F, 10.0F, 0.0F);
		stalk.addChild(stalk_r2);
		setRotationAngle(stalk_r2, 0.0F, -0.8727F, 0.0F);
		stalk_r2.setTextureOffset(8, 26).addBox(-2.5F, -17.2F, 0.0F, 5.0F, 5.0F, 0.0F, 0.0F, false);

		stalk_r3 = new ModelRenderer(this);
		stalk_r3.setRotationPoint(0.0F, 10.0F, 0.0F);
		stalk.addChild(stalk_r3);
		setRotationAngle(stalk_r3, 0.0F, -2.3998F, 0.0F);
		stalk_r3.setTextureOffset(8, 26).addBox(-2.5F, -17.2F, -0.1F, 5.0F, 5.0F, 0.0F, 0.0F, false);

		stalk_r4 = new ModelRenderer(this);
		stalk_r4.setRotationPoint(0.0F, 10.0F, 0.0F);
		stalk.addChild(stalk_r4);
		setRotationAngle(stalk_r4, 0.0F, 0.7418F, 0.0F);
		stalk_r4.setTextureOffset(8, 26).addBox(-2.5F, -17.2F, 0.1F, 5.0F, 5.0F, 0.0F, 0.0F, false);

		stalk_r5 = new ModelRenderer(this);
		stalk_r5.setRotationPoint(0.0F, 10.0F, 0.0F);
		stalk.addChild(stalk_r5);
		setRotationAngle(stalk_r5, 0.0F, 1.5272F, 0.0F);
		stalk_r5.setTextureOffset(8, 26).addBox(-2.5F, -17.2F, 0.1F, 5.0F, 5.0F, 0.0F, 0.0F, false);

		stalk_r6 = new ModelRenderer(this);
		stalk_r6.setRotationPoint(0.0F, 10.0F, 0.0F);
		stalk.addChild(stalk_r6);
		setRotationAngle(stalk_r6, 0.0F, 3.1416F, 0.0F);
		stalk_r6.setTextureOffset(8, 26).addBox(-2.5F, -17.2F, -0.1F, 5.0F, 5.0F, 0.0F, 0.0F, false);
		...
		ears2.setTextureOffset(19, 27).addBox(-10.3F, 0.2F, 1.5F, 4.0F, 1.0F, 0.0F, 0.0F, false);
		...
		frill4.setTextureOffset(12, 11).addBox(0.7F, 1.0F, 1.9F, 4.0F, 1.0F, 0.0F, 0.0F, false);
