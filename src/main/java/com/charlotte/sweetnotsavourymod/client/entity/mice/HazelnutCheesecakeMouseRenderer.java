...
public class HazelnutCheesecakeMouseRenderer extends GeoEntityRenderer <HazelnutCheesecakeMouseEntity> {
	...
	public static final ResourceLocation TEXTURE = new ResourceLocation(SweetNotSavouryMod.MOD_ID, 
			"textures/entity/mice/hazelnutcheesecakemouse.png");
	
	public HazelnutCheesecakeMouseRenderer(EntityRendererManager renderManager) {
		
		super(renderManager, new HazelnutCheesecakeMouseModel()); 
		this.shadowSize = 0.2F;			
	}

	@Override
	public ResourceLocation getEntityTexture(HazelnutCheesecakeMouseEntity entity) {
		return TEXTURE;
	}	
	
	@Override
    public void renderEarly(HazelnutCheesecakeMouseEntity animatable, MatrixStack stackIn, float ticks,
