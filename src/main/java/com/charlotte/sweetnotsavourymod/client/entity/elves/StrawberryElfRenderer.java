...
import com.charlotte.sweetnotsavourymod.client.entity.model.elves.StrawberryElfModel;
...
public class StrawberryElfRenderer extends GeoEntityRenderer <StrawberryElfEntity> {

	public static final ResourceLocation TEXTURE = new ResourceLocation(SweetNotSavouryMod.MOD_ID, 
			"textures/entity/strawberryelf/strawberryelf.png");
	
	public StrawberryElfRenderer(EntityRendererManager renderManager) {
		
		super(renderManager, new StrawberryElfModel()); 
	...
	@Override
    public void renderEarly(StrawberryElfEntity animatable, MatrixStack stackIn, float ticks,
