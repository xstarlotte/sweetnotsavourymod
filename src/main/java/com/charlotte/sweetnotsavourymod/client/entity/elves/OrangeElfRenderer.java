...
import com.charlotte.sweetnotsavourymod.client.entity.model.elves.OrangeElfModel;
...
public class OrangeElfRenderer extends GeoEntityRenderer <OrangeElfEntity> {
	...
	@Override
    public void renderEarly(OrangeElfEntity animatable, MatrixStack stackIn, float ticks,
