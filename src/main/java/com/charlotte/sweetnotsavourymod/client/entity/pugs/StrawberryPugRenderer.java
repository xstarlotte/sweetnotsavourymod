...
import com.charlotte.sweetnotsavourymod.client.entity.model.pugs.StrawberryPugModel;
...
public class StrawberryPugRenderer extends GeoEntityRenderer <StrawberryPugEntity> {
	...
	public static final ResourceLocation TEXTURE = new ResourceLocation(SweetNotSavouryMod.MOD_ID, 
			"textures/entity/pugs/strawberrypug.png");
	...
	@Override
    public void renderEarly(StrawberryPugEntity animatable, MatrixStack stackIn, float ticks,
