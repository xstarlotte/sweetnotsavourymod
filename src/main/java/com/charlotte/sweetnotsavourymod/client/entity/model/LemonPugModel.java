...
public class LemonPugModel<T extends LemonPugEntity> extends EntityModel<T>{
	...
	public LemonPugModel() {
		...
		setRotationAngle(cube_r1, -0.1583F, -0.0345F, -0.0112F);
		cube_r1.setTextureOffset(46, 26).addBox(-2.6F, -3.6F, -0.7F, 5.0F, 4.0F, 0.0F, 0.0F, false);
