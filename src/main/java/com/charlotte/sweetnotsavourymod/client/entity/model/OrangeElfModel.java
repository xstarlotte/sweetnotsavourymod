...
public class OrangeElfModel<T extends OrangeElfEntity> extends EntityModel<T> {
	...
	public OrangeElfModel() {
		...
		stalk_r1.setTextureOffset(8, 26).addBox(-2.5F, -17.2F, 0.1F, 5.0F, 5.0F, 0.0F, 0.0F, false);

		stalk_r2 = new ModelRenderer(this);
		stalk_r2.setRotationPoint(0.0F, 10.0F, 0.0F);
		stalk.addChild(stalk_r2);
		setRotationAngle(stalk_r2, 0.0F, 0.7418F, 0.0F);
		stalk_r2.setTextureOffset(8, 26).addBox(-2.5F, -17.2F, 0.1F, 5.0F, 5.0F, 0.0F, 0.0F, false);

		stalk_r3 = new ModelRenderer(this);
		stalk_r3.setRotationPoint(0.0F, 10.0F, 0.0F);
		stalk.addChild(stalk_r3);
		setRotationAngle(stalk_r3, 0.0F, 1.5272F, 0.0F);
