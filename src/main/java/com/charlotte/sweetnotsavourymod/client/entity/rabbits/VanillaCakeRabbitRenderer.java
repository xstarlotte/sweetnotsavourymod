...
import com.charlotte.sweetnotsavourymod.client.entity.model.rabbits.VanillaCakeRabbitModel;
...
public class VanillaCakeRabbitRenderer extends GeoEntityRenderer <VanillaCakeRabbitEntity> {
	...
	@Override
    public void renderEarly(VanillaCakeRabbitEntity animatable, MatrixStack stackIn, float ticks,
