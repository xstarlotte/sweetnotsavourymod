...
public class LemonElfModel<T extends LemonElfEntity> extends EntityModel<T> {
	...
	public LemonElfModel() {
		...
		setRotationAngle(stalk_r1, -3.0185F, 0.0447F, -2.5716F);
		stalk_r1.setTextureOffset(4, 22).addBox(4.6F, -14.3F, 1.1F, 4.0F, 5.0F, 0.0F, 0.0F, false);

		stalk_r2 = new ModelRenderer(this);
		stalk_r2.setRotationPoint(0.0F, 10.0F, 0.0F);
		stalk.addChild(stalk_r2);
		setRotationAngle(stalk_r2, 0.0F, 0.0F, -0.6545F);
		stalk_r2.setTextureOffset(4, 22).addBox(5.4F, -14.0F, -0.1F, 4.0F, 5.0F, 0.0F, 0.0F, false);
