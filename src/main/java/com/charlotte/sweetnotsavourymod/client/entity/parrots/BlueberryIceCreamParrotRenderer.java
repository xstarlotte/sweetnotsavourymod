...
import com.charlotte.sweetnotsavourymod.client.entity.model.parrots.BlueberryIceCreamParrotModel;
...
public class BlueberryIceCreamParrotRenderer extends GeoEntityRenderer <BlueberryIceCreamParrotEntity> {

	public static final ResourceLocation TEXTURE = new ResourceLocation(SweetNotSavouryMod.MOD_ID, 
			"textures/entity/blueberryicecreamparrot/blueberryicecreamparrot.png");
	
	public BlueberryIceCreamParrotRenderer(EntityRendererManager renderManager) {
		
		super(renderManager, new BlueberryIceCreamParrotModel()); 
	...
	@Override
	public void render(BlueberryIceCreamParrotEntity entity, float entityYaw, float partialTicks, MatrixStack stack,
	 ...
	 @Override
	    public void renderEarly(BlueberryIceCreamParrotEntity animatable, MatrixStack stackIn, float ticks,
