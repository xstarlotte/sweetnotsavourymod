...
public class MangoCandyArmorItem extends GeoArmorItem implements IAnimatable {
    ...
    private static final Map<IArmorMaterial, Supplier<EffectInstance[]>> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<IArmorMaterial, Supplier<EffectInstance[]>>())
                    .put(ModArmorMaterials.MANGO_CANDY,
                            () -> new EffectInstance[] {
    ...
    public MangoCandyArmorItem(IArmorMaterial material, EquipmentSlotType slot, Properties settings) {
        super(material, slot, settings);
    }

    @Override
    public void registerControllers(AnimationData data) {
        data.addAnimationController(new AnimationController<MangoCandyArmorItem>(this, "controller",
                20, this::predicate));
    }
