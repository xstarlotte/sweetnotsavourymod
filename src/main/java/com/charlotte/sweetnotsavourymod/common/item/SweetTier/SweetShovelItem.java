package com.charlotte.sweetnotsavourymod.common.item.SweetTier;
...
public class SweetShovelItem extends ShovelItem {
    public SweetShovelItem(Tier p_43269_, int p_43270_, float p_43271_, Properties p_43272_) {
