...
public class JamPresserBlockEntity extends TileEntity implements INamedContainerProvider, ITickableTileEntity {
    ...
    public JamPresserBlockEntity() {
        super(BlockEntityTypesInit.JAM_PRESSER.get());
    }


    @Override
    public ITextComponent getDisplayName() {
        return new StringTextComponent("Jam Presser");
    }
    ...
    private static boolean hasRecipe(JamPresserBlockEntity entity) {
        ...
        Optional<JamPresserRecipe> match = level.getRecipeManager()
                .getRecipeFor(JamPresserRecipe.Type.INSTANCE, inventory, level);
