...
public class StrawberryWaffleBedBeRenderer extends BaseBedBeRenderer {
    ...
    protected void setBlockEntityAndModels(SNSBaseBedBlockEntity be){
        ...
        this.bottombedmodel = Minecraft.getInstance().getModelManager().getModel(ClientEventBusSubscriber.STRAWBERRYWAFFLEBEDBOTTOM);
        this.headbedmodel = Minecraft.getInstance().getModelManager().getModel(ClientEventBusSubscriber.STRAWBERRYWAFFLEBEDHEAD);
    }
}