...
public class WaffleConeMachineBlockEntity extends TileEntity implements INamedContainerProvider {
    ...
    public static void tick(World pLevel, BlockPos pPos, BlockState pState, WaffleConeMachineBlockEntity pBlockEntity) {
