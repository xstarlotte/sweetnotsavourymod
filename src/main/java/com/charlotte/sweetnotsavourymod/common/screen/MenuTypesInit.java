...
public class MenuTypesInit {
    ...
    public static final RegistryObject<ContainerType<IceCreamMachineMenu>> ICE_CREAM_MACHINE_MENU =
            registerMenuType(IceCreamMachineMenu::new, "ice_cream_machine_menu");

    public static final RegistryObject<ContainerType<BananaBakerMenu>> BANANA_BAKER_MENU =
            registerMenuType(BananaBakerMenu::new, "banana_baker_menu");

    public static final RegistryObject<ContainerType<JamPresserMenu>> JAM_PRESSER_MENU =
            registerMenuType(JamPresserMenu::new, "jam_presser_menu");

    public static final RegistryObject<ContainerType<WaffleConeMachineMenu>> WAFFLE_CONE_MACHINE_MENU =
            registerMenuType(WaffleConeMachineMenu::new, "waffle_cone_machine_menu");

    public static final RegistryObject<ContainerType<CakeBakerMenu>> CAKE_BAKER_MENU =
            registerMenuType(CakeBakerMenu::new, "cake_baker_menu");

    public static final RegistryObject<ContainerType<CandycaneFurnaceMenu>> CANDYCANE_FURNACE_MENU =
            registerMenuType(CandycaneFurnaceMenu::new, "candycane_furnace_menu");

    public static final RegistryObject<ContainerType<TeddyBearPrinterMenu>> TEDDY_BEAR_PRINTER_MENU =
            registerMenuType(TeddyBearPrinterMenu::new, "teddy_bear_printer_menu");

    public static final RegistryObject<ContainerType<CandyflossCrystalizerMenu>> CANDYFLOSS_CRYSTALIZER_MENU =
    ...
    private static <T extends Container> RegistryObject<ContainerType<T>> registerMenuType(IContainerFactory<T> factory,
                                                                                           String name) {
        return MENUS.register(name, () -> new ContainerType<>(factory));
    }
