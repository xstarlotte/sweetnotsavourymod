...
public class SNSIceCreamParrotEntity extends TameableEntity implements IAnimatable {
	private AnimationFactory factory = new AnimationFactory(this);
	private static final DataParameter<Integer> DATA_ID_TYPE_VARIANT =
			EntityDataManager.defineId(com.charlotte.sweetnotsavourymod.common.entity.birds.SNSIceCreamParrotEntity.class, DataSerializers.INT);

	private static final DataParameter<Boolean> SITTING =
			EntityDataManager.defineId(com.charlotte.sweetnotsavourymod.common.entity.birds.SNSIceCreamParrotEntity.class, DataSerializers.BOOLEAN);

	public SNSIceCreamParrotEntity(EntityType<? extends TameableEntity> type, Level worldIn) {
		super(type, worldIn);
		setTame(false);
