...
public class SNSICFishEntity extends AbstractGroupFishEntity implements IAnimatable {
    ...
    public SNSICFishEntity(EntityType<? extends AbstractGroupFishEntity> type, World worldIn) {
        super(type, worldIn);
        this.noCulling = true;
    }
    ...
    private void setVariant(ICFishVariant variant) {
