...
public class RaspberryIceCreamParrotEntity extends TamableAnimal implements IAnimatable {
	private AnimationFactory factory = new AnimationFactory(this);

	private static final EntityDataAccessor<Boolean> SITTING =
			SynchedEntityData.defineId(RaspberryIceCreamParrotEntity.class, EntityDataSerializers.BOOLEAN);

	public RaspberryIceCreamParrotEntity(EntityType<? extends TamableAnimal> type, Level worldIn) {
		super(type, worldIn);
		setTame(false);
		this.noCulling = true;
	}
