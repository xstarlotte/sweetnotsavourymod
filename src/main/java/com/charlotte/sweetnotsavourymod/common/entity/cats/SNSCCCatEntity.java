...
public class SNSCCCatEntity extends TamableAnimal implements IAnimatable, IVariable<CatFlavourVariant> {

	private AnimationFactory factory = GeckoLibUtil.createFactory(this);

	private static final EntityDataAccessor<Integer> DATA_ID_TYPE_VARIANT =
			SynchedEntityData.defineId(com.charlotte.sweetnotsavourymod.common.entity.cats.SNSCCCatEntity.class, EntityDataSerializers.INT);
	private static final EntityDataAccessor<Boolean> SITTING =
			SynchedEntityData.defineId(com.charlotte.sweetnotsavourymod.common.entity.cats.SNSCCCatEntity.class, EntityDataSerializers.BOOLEAN);
...
//breeding
	...
	@Override
	public void setVariant(CatFlavourVariant variant) {
