...
public class RaspberryParrotEntity extends TamableAnimal implements IAnimatable {
	private AnimationFactory factory = new AnimationFactory(this);

	private static final EntityDataAccessor<Boolean> SITTING =
			SynchedEntityData.defineId(RaspberryParrotEntity.class, EntityDataSerializers.BOOLEAN);

	public RaspberryParrotEntity(EntityType<? extends TamableAnimal> type, Level worldIn) {
		super(type, worldIn);
		setTame(false);
		this.noCulling = true;
	}
