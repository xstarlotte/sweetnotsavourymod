package com.charlotte.sweetnotsavourymod.common.entity.gummybears;
...
public class SNSGummyBearEntity extends TamableAnimal implements IAnimatable {
	private AnimationFactory factory = new AnimationFactory(this);
	private static final EntityDataAccessor<Integer> DATA_ID_TYPE_VARIANT =
			SynchedEntityData.defineId(SNSGummyBearEntity.class, EntityDataSerializers.INT);

	private static final EntityDataAccessor<Boolean> SITTING =
			SynchedEntityData.defineId(SNSGummyBearEntity.class, EntityDataSerializers.BOOLEAN);
	...
	protected void playStepSound(BlockPos pos, BlockState blockIn) {
		this.playSound(SoundEvents.HONEY_BLOCK_STEP, 0.15F, 1.0F);
	}
	...
	public AgeableMob getBreedOffspring(ServerLevel serverLevel, AgeableMob p_146744_) {
		return EntityTypesInit.SNSGUMMYBEAR.get().create(serverLevel);
	}
