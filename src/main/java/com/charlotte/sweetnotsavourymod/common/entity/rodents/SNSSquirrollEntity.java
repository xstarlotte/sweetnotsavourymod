...
public class SNSSquirrollEntity extends TameableEntity implements IAnimatable {

    private AnimationFactory factory = new AnimationFactory(this);

    private static final DataParameter<Integer> DATA_ID_TYPE_VARIANT =
            EntityDataManager.defineId(com.charlotte.sweetnotsavourymod.common.entity.rodents.SNSSquirrollEntity.class, DataSerializers.INT);
    private static final DataParameter<Boolean> SITTING =
            EntityDataManager.defineId(com.charlotte.sweetnotsavourymod.common.entity.rodents.SNSSquirrollEntity.class, DataSerializers.BOOLEAN);

    public SNSSquirrollEntity(EntityType<? extends TameableEntity> type, Level worldIn) {
        super(type, worldIn);
        setTame(false);
        this.noCulling = true;
    }
