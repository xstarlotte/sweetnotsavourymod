package com.charlotte.sweetnotsavourymod.common.entity.lions;

import com.charlotte.sweetnotsavourymod.core.init.EntityTypesInit;
import com.charlotte.sweetnotsavourymod.core.init.ItemInit;
import com.charlotte.sweetnotsavourymod.core.util.LionVariant;
import com.charlotte.sweetnotsavourymod.core.util.SheepVariant;
...
public class SNSLionEntity extends TamableAnimal implements IAnimatable {
	...
	private static final EntityDataAccessor<Integer> DATA_ID_TYPE_VARIANT =
			SynchedEntityData.defineId(SNSLionEntity.class, EntityDataSerializers.INT);

	private static final EntityDataAccessor<Boolean> SITTING =
			SynchedEntityData.defineId(SNSLionEntity.class, EntityDataSerializers.BOOLEAN);
	...
	private <E extends IAnimatable> PlayState predicate(AnimationEvent<E> event) {
		...
		if (event.isMoving()) {
			event.getController().setAnimation(new AnimationBuilder().addAnimation("animation.lion.running", true));
			return PlayState.CONTINUE;
		}

		if (this.isSitting()) {
			event.getController().setAnimation(new AnimationBuilder().addAnimation("animation.lion.sitting", true));
			return PlayState.CONTINUE;
		}

		event.getController().setAnimation(new AnimationBuilder().addAnimation("animation.lion.idle", true));
		return PlayState.CONTINUE;
	}
	...
	public AgeableMob getBreedOffspring(ServerLevel serverLevel, AgeableMob p_146744_) {
		return EntityTypesInit.SNSLION.get().create(serverLevel);
	}
