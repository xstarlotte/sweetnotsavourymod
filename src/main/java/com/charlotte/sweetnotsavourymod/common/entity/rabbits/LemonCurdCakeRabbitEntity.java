...
public class LemonCurdCakeRabbitEntity extends TameableEntity implements IAnimatable
{
	private AnimationFactory factory = new AnimationFactory(this);
	
	private static final DataParameter<Boolean> SITTING = EntityDataManager.createKey(LemonCurdCakeRabbitEntity.class, DataSerializers.BOOLEAN);
	
	public LemonCurdCakeRabbitEntity(EntityType<? extends TameableEntity> type, World worldIn) {
		super(type, worldIn);
		setTamed(false);
