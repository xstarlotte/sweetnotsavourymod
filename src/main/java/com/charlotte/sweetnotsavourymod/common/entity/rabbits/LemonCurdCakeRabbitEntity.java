...
public class LemonCurdCakeRabbitEntity extends TamableAnimal implements IAnimatable {
	private AnimationFactory factory = new AnimationFactory(this);

	private static final EntityDataAccessor<Boolean> SITTING =
			SynchedEntityData.defineId(LemonCurdCakeRabbitEntity.class, EntityDataSerializers.BOOLEAN);

	public LemonCurdCakeRabbitEntity(EntityType<? extends TamableAnimal> type, Level worldIn) {
		super(type, worldIn);
		setTame(false);
		this.noCulling = true;
	}
