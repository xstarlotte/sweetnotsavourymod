...
public class HazelnutCheesecakeMouseEntity extends TameableEntity implements IAnimatable
{
	private AnimationFactory factory = new AnimationFactory(this);
	
	private static final DataParameter<Boolean> SITTING = EntityDataManager.createKey(HazelnutCheesecakeMouseEntity.class, DataSerializers.BOOLEAN);
	
	public HazelnutCheesecakeMouseEntity(EntityType<? extends TameableEntity> type, World worldIn) {
		super(type, worldIn);
		setTamed(false);
