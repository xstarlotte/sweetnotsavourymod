...
public class BlueberryIceCreamParrotEntity extends TameableEntity implements IAnimatable
{
	private AnimationFactory factory = new AnimationFactory(this);
	
	private static final DataParameter<Boolean> SITTING = EntityDataManager.createKey(BlueberryIceCreamParrotEntity.class, DataSerializers.BOOLEAN);
	
	public BlueberryIceCreamParrotEntity(EntityType<? extends TameableEntity> type, World worldIn) {
		super(type, worldIn);	
		setTamed(false);
