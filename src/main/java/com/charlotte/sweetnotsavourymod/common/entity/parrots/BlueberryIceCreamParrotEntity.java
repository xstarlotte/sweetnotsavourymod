...
public class BlueberryIceCreamParrotEntity extends TamableAnimal implements IAnimatable {
	private AnimationFactory factory = new AnimationFactory(this);

	private static final EntityDataAccessor<Boolean> SITTING =
			SynchedEntityData.defineId(BlueberryIceCreamParrotEntity.class, EntityDataSerializers.BOOLEAN);

	public BlueberryIceCreamParrotEntity(EntityType<? extends TamableAnimal> type, Level worldIn) {
		super(type, worldIn);
		setTame(false);
		this.noCulling = true;
	}
