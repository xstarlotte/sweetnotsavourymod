...
public class SNSSheepEntity extends TamableAnimal implements IAnimatable {
	...
	private static final EntityDataAccessor<Boolean> SITTING =
			SynchedEntityData.defineId(com.charlotte.sweetnotsavourymod.common.entity.sheep.SNSSheepEntity.class, EntityDataSerializers.BOOLEAN);

	public SNSSheepEntity(EntityType<? extends TamableAnimal> type, Level worldIn) {
		super(type, worldIn);
		setTame(false);
		this.noCulling = true;
	}
