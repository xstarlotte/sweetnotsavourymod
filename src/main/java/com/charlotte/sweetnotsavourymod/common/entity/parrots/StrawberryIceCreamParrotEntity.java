...
public class StrawberryIceCreamParrotEntity extends TameableEntity implements IAnimatable
{
	private AnimationFactory factory = new AnimationFactory(this);
	
	private static final DataParameter<Boolean> SITTING = EntityDataManager.createKey(StrawberryIceCreamParrotEntity.class, DataSerializers.BOOLEAN);
	
	public StrawberryIceCreamParrotEntity(EntityType<? extends TameableEntity> type, World worldIn) {
		super(type, worldIn);	
		setTamed(false);
