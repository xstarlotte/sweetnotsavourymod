...
public class MarshmallowPieMouseEntity extends TameableEntity implements IAnimatable
{
	private AnimationFactory factory = new AnimationFactory(this);
	
	private static final DataParameter<Boolean> SITTING = EntityDataManager.createKey(MarshmallowPieMouseEntity.class, DataSerializers.BOOLEAN);
	
	public MarshmallowPieMouseEntity(EntityType<? extends TameableEntity> type, World worldIn) {
		super(type, worldIn);
		setTamed(false);
