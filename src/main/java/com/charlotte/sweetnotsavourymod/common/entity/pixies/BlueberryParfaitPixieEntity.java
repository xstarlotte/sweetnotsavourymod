...
public class BlueberryParfaitPixieEntity extends TameableEntity implements IAnimatable
{
	private AnimationFactory factory = new AnimationFactory(this);
	
	private static final DataParameter<Boolean> SITTING = EntityDataManager.createKey(BlueberryParfaitPixieEntity.class, DataSerializers.BOOLEAN);
	
	public BlueberryParfaitPixieEntity(EntityType<? extends TameableEntity> type, World worldIn) {
		super(type, worldIn);	
		setTamed(false);
