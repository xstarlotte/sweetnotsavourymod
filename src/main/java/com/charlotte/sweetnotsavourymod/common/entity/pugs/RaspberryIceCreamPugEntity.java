...
public class RaspberryIceCreamPugEntity extends TameableEntity implements IAnimatable
{
	...
	public RaspberryIceCreamPugEntity(EntityType<? extends TameableEntity> type, World worldIn) {
		super(type, worldIn);	
		setTamed(false);
