...
public class SNSCandyCanefishEntity extends AbstractSchoolingFish implements IAnimatable {
    ...
    public SNSCandyCanefishEntity(EntityType<? extends AbstractSchoolingFish> type, World worldIn) {
        super(type, worldIn);
        this.noCulling = true;
    }
