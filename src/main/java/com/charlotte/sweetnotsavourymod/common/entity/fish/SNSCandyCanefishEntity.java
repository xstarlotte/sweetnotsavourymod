...
public class SNSCandyCanefishEntity extends AbstractSchoolingFish implements IAnimatable, IVariable<CandyCanefishVariant> {
    ...
    public SNSCandyCanefishEntity(EntityType<? extends AbstractSchoolingFish> type, Level worldIn) {
        super(type, worldIn);
        this.noCulling = true;
    }
    ...
    public SpawnGroupData finalizeSpawn(ServerLevelAccessor p_146746_, DifficultyInstance p_146747_,
        ...
        CandyCanefishVariant variant = Util.getRandom(CandyCanefishVariant.values(), this.random);
        setVariant(variant);
        return super.finalizeSpawn(p_146746_, p_146747_, p_146748_, p_146749_, p_146750_);
    }

    @Override
    public void setVariant(CandyCanefishVariant variant) {
        this.entityData.set(DATA_ID_TYPE_VARIANT, variant.getId() & 255);
    }

    @Override
    public CandyCanefishVariant getVariant() {
        return CandyCanefishVariant.byId(this.getTypeVariant() & 255);
    }
