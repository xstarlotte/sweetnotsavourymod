...
public class ChocolateIceCreamPugEntity extends TamableAnimal implements IAnimatable {
	private AnimationFactory factory = new AnimationFactory(this);

	private static final EntityDataAccessor<Boolean> SITTING =
			SynchedEntityData.defineId(ChocolateIceCreamPugEntity.class, EntityDataSerializers.BOOLEAN);

	public ChocolateIceCreamPugEntity(EntityType<? extends TamableAnimal> type, Level worldIn) {
		super(type, worldIn);
		setTame(false);
		this.noCulling = true;
	}
