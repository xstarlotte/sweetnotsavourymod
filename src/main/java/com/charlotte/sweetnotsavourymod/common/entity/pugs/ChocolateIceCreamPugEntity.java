...
public class ChocolateIceCreamPugEntity extends TameableEntity implements IAnimatable
{
	...
	public ChocolateIceCreamPugEntity(EntityType<? extends TameableEntity> type, World worldIn) {
		super(type, worldIn);	
		setTamed(false);
