...
public class SNSAngelFishEntity extends AbstractGroupFishEntity implements IAnimatable {
    private AnimationFactory factory = new AnimationFactory(this);
    private static final DataParameter<Integer> DATA_ID_TYPE_VARIANT =
            EntityDataManager.defineId(SNSAngelFishEntity.class, DataSerializers.INT);

    public SNSAngelFishEntity(EntityType<? extends AbstractGroupFishEntity> type, World worldIn) {
        super(type, worldIn);
        this.noCulling = true;
    }
