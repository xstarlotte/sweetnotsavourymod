...
public class SNSToadEntity extends TamableAnimal implements IAnimatable {
	...
	private static final EntityDataAccessor<Boolean> SITTING =
			SynchedEntityData.defineId(SNSToadEntity.class, EntityDataSerializers.BOOLEAN);

	public SNSToadEntity(EntityType<? extends TamableAnimal> type, Level worldIn) {
		super(type, worldIn);
		setTame(false);
		this.noCulling = true;
	}
