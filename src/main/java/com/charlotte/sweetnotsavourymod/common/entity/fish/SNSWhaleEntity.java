...
public class SNSWhaleEntity extends AbstractGroupFishEntity implements IAnimatable {
    private AnimationFactory factory = new AnimationFactory(this);
    private static final DataParameter<Integer> DATA_ID_TYPE_VARIANT =
            EntityDataManager.defineId(SNSWhaleEntity.class, DataSerializers.INT);

    public SNSWhaleEntity(EntityType<? extends AbstractGroupFishEntity> type, World worldIn) {
        super(type, worldIn);
        this.noCulling = true;
    }
    ...
    public ILivingEntityData finalizeSpawn(IServerWorld p_146746_, DifficultyInstance p_146747_,
        ...
        WhaleVariant variant = Util.getRandom(WhaleVariant.values(), this.random);
        setVariant(variant);
