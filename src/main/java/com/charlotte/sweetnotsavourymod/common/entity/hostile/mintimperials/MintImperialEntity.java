...
public class MintImperialEntity extends MonsterEntity implements IAnimatable {
    ...
    public MintImperialEntity(EntityType<? extends MonsterEntity> type, World worldIn) {
        super(type, worldIn);
		this.noCulling = true;
    }
