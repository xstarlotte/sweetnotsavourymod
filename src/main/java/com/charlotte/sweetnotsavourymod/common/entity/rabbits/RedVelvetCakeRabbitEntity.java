...
public class RedVelvetCakeRabbitEntity extends TameableEntity implements IAnimatable
{
	private AnimationFactory factory = new AnimationFactory(this);
	
	private static final DataParameter<Boolean> SITTING = EntityDataManager.createKey(RedVelvetCakeRabbitEntity.class, DataSerializers.BOOLEAN);
	
	public RedVelvetCakeRabbitEntity(EntityType<? extends TameableEntity> type, World worldIn) {
		super(type, worldIn);
		setTamed(false);
