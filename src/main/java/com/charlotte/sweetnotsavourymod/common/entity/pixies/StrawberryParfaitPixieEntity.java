...
public class StrawberryParfaitPixieEntity extends TamableAnimal implements IAnimatable {
	private AnimationFactory factory = new AnimationFactory(this);

	private static final EntityDataAccessor<Boolean> SITTING =
			SynchedEntityData.defineId(StrawberryParfaitPixieEntity.class, EntityDataSerializers.BOOLEAN);

	public StrawberryParfaitPixieEntity(EntityType<? extends TamableAnimal> type, Level worldIn) {
		super(type, worldIn);
		setTame(false);
		this.noCulling = true;
	}
