...
public class StrawberryParfaitPixieEntity extends TameableEntity implements IAnimatable
{
	private AnimationFactory factory = new AnimationFactory(this);
	
	private static final DataParameter<Boolean> SITTING = EntityDataManager.createKey(StrawberryParfaitPixieEntity.class, DataSerializers.BOOLEAN);
	
	public StrawberryParfaitPixieEntity(EntityType<? extends TameableEntity> type, World worldIn) {
		super(type, worldIn);	
		setTamed(false);
