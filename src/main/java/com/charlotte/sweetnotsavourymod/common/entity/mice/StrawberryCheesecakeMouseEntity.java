...
public class StrawberryCheesecakeMouseEntity extends TameableEntity implements IAnimatable
{
	private AnimationFactory factory = new AnimationFactory(this);
	
	private static final DataParameter<Boolean> SITTING = EntityDataManager.createKey(StrawberryCheesecakeMouseEntity.class, DataSerializers.BOOLEAN);
	
	public StrawberryCheesecakeMouseEntity(EntityType<? extends TameableEntity> type, World worldIn) {
		super(type, worldIn);
		setTamed(false);
