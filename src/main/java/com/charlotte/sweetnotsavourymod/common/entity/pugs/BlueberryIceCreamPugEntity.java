...
public class BlueberryIceCreamPugEntity extends TameableEntity implements IAnimatable
{
	...
	public BlueberryIceCreamPugEntity(EntityType<? extends TameableEntity> type, World worldIn) {
		super(type, worldIn);	
		setTamed(false);
