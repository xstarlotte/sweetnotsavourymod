...
public class StrawberryIceCreamPugEntity extends TameableEntity implements IAnimatable
{
	...
	public StrawberryIceCreamPugEntity(EntityType<? extends TameableEntity> type, World worldIn) {
		super(type, worldIn);	
		setTamed(false);
