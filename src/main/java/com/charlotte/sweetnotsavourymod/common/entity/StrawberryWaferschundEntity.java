...
public class StrawberryWaferschundEntity extends TameableEntity implements IAnimatable
{
	private AnimationFactory factory = new AnimationFactory(this);
	
	private static final DataParameter<Boolean> SITTING = EntityDataManager.createKey(LemonPugEntity.class, DataSerializers.BOOLEAN);
	
	public StrawberryWaferschundEntity(EntityType<? extends TameableEntity> type, World worldIn) {
		super(type, worldIn);	
		setTamed(false);
