...
import com.charlotte.sweetnotsavourymod.core.util.CookieCatFlavourVariant;
...
public class SNSCookieCatEntity extends TamableAnimal implements IAnimatable {
	...
	private static final EntityDataAccessor<Integer> DATA_ID_TYPE_VARIANT =
			SynchedEntityData.defineId(SNSCookieCatEntity.class, EntityDataSerializers.INT);

	private static final EntityDataAccessor<Boolean> SITTING =
			SynchedEntityData.defineId(SNSCookieCatEntity.class, EntityDataSerializers.BOOLEAN);
	...
	public AgeableMob getBreedOffspring(ServerLevel serverLevel, AgeableMob p_146744_) {
		return EntityTypesInit.SNSCOOKIECAT.get().create(serverLevel);
	}
