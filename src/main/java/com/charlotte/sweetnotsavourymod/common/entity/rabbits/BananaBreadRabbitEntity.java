...
public class BananaBreadRabbitEntity extends TameableEntity implements IAnimatable
{
	private AnimationFactory factory = new AnimationFactory(this);
	
	private static final DataParameter<Boolean> SITTING = EntityDataManager.createKey(BananaBreadRabbitEntity.class, DataSerializers.BOOLEAN);
	
	public BananaBreadRabbitEntity(EntityType<? extends TameableEntity> type, World worldIn) {
		super(type, worldIn);
		setTamed(false);
