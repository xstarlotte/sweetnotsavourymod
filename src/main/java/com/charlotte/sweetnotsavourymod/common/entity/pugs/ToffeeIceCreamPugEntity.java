...
public class ToffeeIceCreamPugEntity extends TameableEntity implements IAnimatable
{
	...
	public ToffeeIceCreamPugEntity(EntityType<? extends TameableEntity> type, World worldIn) {
		super(type, worldIn);	
		setTamed(false);
