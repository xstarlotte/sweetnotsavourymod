...
public class IceCreamMachineRecipe implements IRecipe<Inventory> {
    ...
    public static class Type implements IRecipeType<IceCreamMachineRecipe> {
        private Type() { }
        public static final Type INSTANCE = new Type();
        public static final String ID = "ice_creaming";
    }

    public static class Serializer implements IRecipeSerializer<IceCreamMachineRecipe> {
        ...
        @Override
        public IceCreamMachineRecipe fromNetwork(ResourceLocation id, PacketBuffer buf) {
        ...
        @Override
        public void toNetwork(PacketBuffer buf, IceCreamMachineRecipe recipe) {
