...
public class TeddyBearPrinterRecipe implements Recipe<SimpleContainer> {

    public static final RecipeType<TeddyBearPrinterRecipe> TYPE = new RecipeType<>() {
        @Override
    ...
    public RecipeSerializer<?> getSerializer() {
        return RecipeSerializerInit.TEDDY_BEAR_PRINTING_SERIALIZER.get();
    }
    ...
    public static class Serializer implements RecipeSerializer<TeddyBearPrinterRecipe> {
        ...
        @Override
        public TeddyBearPrinterRecipe fromNetwork(ResourceLocation id, FriendlyByteBuf buf) {
        ...
        @Override
        public void toNetwork(FriendlyByteBuf buf, TeddyBearPrinterRecipe recipe) {
