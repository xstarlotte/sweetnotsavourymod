...
public class CandycaneFurnaceRecipe implements IRecipe<Inventory> {
    ...
    public static class Type implements IRecipeType<CandycaneFurnaceRecipe> {
        private Type() { }
        public static final Type INSTANCE = new Type();
        public static final String ID = "candycane_smelting";
    }

    public static class Serializer implements IRecipeSerializer<CandycaneFurnaceRecipe> {
        ...
        @Override
        public CandycaneFurnaceRecipe fromNetwork(ResourceLocation id, PacketBuffer buf) {
        ...
        @Override
        public void toNetwork(PacketBuffer buf, CandycaneFurnaceRecipe recipe) {
