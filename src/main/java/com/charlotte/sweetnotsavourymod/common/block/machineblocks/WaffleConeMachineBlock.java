...
public class WaffleConeMachineBlock extends Block implements ITileEntityProvider {
    public static final DirectionProperty FACING = BlockStateProperties.HORIZONTAL_FACING;

    public WaffleConeMachineBlock(Properties properties) {
        super(properties);
...
//    }
    ...
    public ActionResultType use(BlockState pState, World pLevel, BlockPos pPos, PlayerEntity pPlayer, Hand pHand, BlockRayTraceResult pHit) {
        if (!pLevel.isClientSide()) {
            ...
            if(entity instanceof  WaffleConeMachineBlockEntity) {
                NetworkHooks.openGui(((ServerPlayerEntity) pPlayer), (WaffleConeMachineBlockEntity) entity, pPos);
            } else {
    ...
    public TileEntity newBlockEntity() {
        return new WaffleConeMachineBlockEntity();
    }
}
