...
public class BananaBakerBlock extends Block implements ITileEntityProvider {
...
//    }
    ...
    public ActionResultType use(BlockState pState, World pLevel, BlockPos pPos, PlayerEntity pPlayer, Hand pHand, BlockRayTraceResult pHit) {
        if (!pLevel.isClientSide()) {
            ...
            if(entity instanceof  BananaBakerBlockEntity) {
                NetworkHooks.openGui(((ServerPlayerEntity) pPlayer), (BananaBakerBlockEntity) entity, pPos);
            } else {
    ...
    public TileEntity newBlockEntity() {
        return new BananaBakerBlockEntity();
    }
}
