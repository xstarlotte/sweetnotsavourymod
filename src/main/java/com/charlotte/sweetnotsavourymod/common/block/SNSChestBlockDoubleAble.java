...
public class SNSChestBlockDoubleAble extends SNSChestBlock {
	public SNSChestBlockDoubleAble(Properties properties, Supplier<TileEntityType<SNSChestBlockEntity>> blockEntity, Supplier<SNSChestMenuType> menuSingle, Supplier<SNSChestMenuType> menuDouble, int containerSize) {
