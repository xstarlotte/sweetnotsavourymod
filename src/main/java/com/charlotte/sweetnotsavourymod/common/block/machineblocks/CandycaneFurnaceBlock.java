...
public class CandycaneFurnaceBlock extends Block implements ITileEntityProvider {
...
//    }
    ...
    public ActionResultType use(BlockState pState, World pLevel, BlockPos pPos, PlayerEntity pPlayer, Hand pHand, BlockRayTraceResult pHit) {
        if (!pLevel.isClientSide()) {
            ...
            if(entity instanceof  CandycaneFurnaceBlockEntity) {
                NetworkHooks.openGui(((ServerPlayerEntity) pPlayer), (CandycaneFurnaceBlockEntity) entity, pPos);
            } else {
    ...
    public TileEntity newBlockEntity() {
        return new CandycaneFurnaceBlockEntity();
    }
}
