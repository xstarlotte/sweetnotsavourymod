package com.charlotte.sweetnotsavourymod.common.block.lamps;
...
public class StrawberryLollipopLamp extends Block implements IWaterLoggable {
	   ...
	   public StrawberryLollipopLamp(AbstractBlock.Properties properties) {
	      super(properties);
