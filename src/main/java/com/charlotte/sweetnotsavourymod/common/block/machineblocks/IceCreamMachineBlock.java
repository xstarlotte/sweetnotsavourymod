...
public class IceCreamMachineBlock extends Block implements ITileEntityProvider {
...
//    }
    ...
    public void onRemove(BlockState pState, World pLevel, BlockPos pPos, BlockState pNewState, boolean pIsMoving) {
        if(pState.getBlock() != pNewState.getBlock()) {
            ...
            if (blockEntity instanceof IceCreamMachineBlockEntity) {
                ((IceCreamMachineBlockEntity) blockEntity).drops();
            }
         }
    }
    ...
    public ActionResultType use(BlockState pState, World pLevel, BlockPos pPos, PlayerEntity pPlayer, Hand pHand, BlockRayTraceResult pHit) {
        if (!pLevel.isClientSide()) {
            ...
            if(entity instanceof  IceCreamMachineBlockEntity) {
                NetworkHooks.openGui(((ServerPlayerEntity) pPlayer), (IceCreamMachineBlockEntity) entity, pPos);
            } else {
    ...
    public TileEntity newBlockEntity() {
        return new IceCreamMachineBlockEntity();
    }
}
