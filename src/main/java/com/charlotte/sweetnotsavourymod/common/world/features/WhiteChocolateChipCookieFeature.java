...
public class WhiteChocolateChipCookieFeature extends Feature<NoFeatureConfig>{
	
	private static final BlockState WHITECHOCOLATECHIPCOOKIEBLOCK = BlockInit.WHITECHOCOLATECHIPCOOKIEBLOCK.get().getDefaultState();


	public WhiteChocolateChipCookieFeature(Codec<NoFeatureConfig> codec) {
		super(codec);
	...
	public boolean generate(ISeedReader reader, ChunkGenerator generator, Random rand, BlockPos pos,
		...
		for (int i = 0; i < 1; i++)
		setBlockState(reader, pos.up(i), WHITECHOCOLATECHIPCOOKIEBLOCK);
