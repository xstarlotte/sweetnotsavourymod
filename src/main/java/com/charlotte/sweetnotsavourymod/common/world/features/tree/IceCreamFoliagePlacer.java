...
public class IceCreamFoliagePlacer extends FoliagePlacer {
    ...
    @Override
    protected void createFoliage(IWorldGenerationReader reader, Random random, BaseTreeFeatureConfig configuration, int p_230372_4_, Foliage foliageAttachment, int p_230372_6_, int p_230372_7_, Set<BlockPos> p_230372_8_, int p_230372_9_, MutableBoundingBox p_230372_10_) {
        //TODO fix
//        int height = 4;
...
//            }
//
//            tryPlaceLea(reader, stateBiConsumer, random, configuration, blockpos);
